...
class PINN_Elastic2D():
    ...
    def strain_matrix(self, x):
        ...
        self.set_non_linear_conductivity(T)
    ...
    def set_non_linear_conductivity(self, T):
        # Self.K should either be a scaler or a vector with shape (batch_size, 1, 1)
        self.K = 1.0
    ...
    def strain_energy(self, x, return_strain=False, return_stress=False):
        ...
        thermal_point_wise_energy = self.K*tf.matmul(thermal_gradient, thermal_gradient, transpose_b=True)/2.0
